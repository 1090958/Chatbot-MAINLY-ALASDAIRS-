...
Pretend you’re the generator what would the generator return when input = ‘I will heal mary’, held=‘Axe’, items=[‘Sword’, ‘Axe’, ‘dagger’], enemies=[‘Timothy’,’Gerald’], Allies=[‘Mary Poppins’]

only give the output of the generator as an answer
'''
...
def generate(inputs = 'I will heal mary', held='Axe', items=['Sword', 'Axe', 'Dagger'], enemies=['Timothy','Gerald'], Allies=['Mary Poppins']):
    pass
inputs = 'I will heal mary'
held='Axe'
items=['Sword', 'Axe', 'Dagger']
enemies=['Timothy','Gerald']
Allies=['Mary Poppins']
inputinfo=f'''
The generator is a computer that returns a function given : 
an input(input), 
